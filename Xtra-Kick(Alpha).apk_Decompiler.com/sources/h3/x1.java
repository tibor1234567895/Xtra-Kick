...
public final class x1 implements z, i1 {

    /* renamed from: h  reason: collision with root package name */
    public final b3 f7432h;

    /* renamed from: i  reason: collision with root package name */
    public final g2 f7433i;

    /* renamed from: j  reason: collision with root package name */
    public final Map f7434j;

    public x1(b3 b3Var, g2 g2Var, HashMap hashMap) {
        this.f7432h = b3Var;
        this.f7433i = g2Var;
        this.f7434j = hashMap;
    }
    ...
    public final void C(boolean z10) {
        if (z10) {
            this.f7432h.g(this.f7433i, false);
        }
    }
    ...
    public final void b() {
        b3 b3Var = this.f7432h;
        g2 g2Var = this.f7433i;
        b3Var.h(g2Var);
        b3Var.g(g2Var, false);
    }
    ...
    public final a0 d(b0 b0Var, f4 f4Var, Bundle bundle) {
    ...
    public final a0 w(List list) {
        r0 j10 = r0.j(list);
        Map map = this.f7434j;
        g2 g2Var = this.f7433i;
        map.put(g2Var, j10);
        this.f7432h.g(g2Var, false);
