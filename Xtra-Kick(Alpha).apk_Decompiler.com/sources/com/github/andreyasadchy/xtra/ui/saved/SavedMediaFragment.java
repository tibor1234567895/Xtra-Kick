...
public final class SavedMediaFragment extends p implements c0 {
    ...
    public static final /* synthetic */ int f3452h0 = 0;
    ...
    public final void Z(View view, Bundle bundle) {
        ...
        ((ImageView) hVar.f17660f).setOnClickListener(new i(13, this));
        hVar.f17655a.setOnClickListener(new d(mainActivity, account, this, 11));
        View view2 = hVar.f17661g;
        Spinner spinner = (Spinner) view2;
        j.e("spinner", spinner);
        h0.b2(spinner);
        ((Spinner) view2).setAdapter(new ArrayAdapter(mainActivity, 17367049, y().getStringArray(R.array.spinnerSavedEntries)));
        ((Spinner) view2).setOnItemSelectedListener(new v2(5, this));
    }
