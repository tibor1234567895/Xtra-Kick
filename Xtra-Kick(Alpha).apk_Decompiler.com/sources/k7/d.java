...
public abstract class d extends x implements b {
    ...
    public volatile h f9250m0;

    /* renamed from: n0  reason: collision with root package name */
    public final Object f9251n0 = new Object();
    ...
    public final Object c() {
        if (this.f9250m0 == null) {
            synchronized (this.f9251n0) {
                if (this.f9250m0 == null) {
                    this.f9250m0 = new h((c0) this);
                }
            }
        }
        return this.f9250m0.c();
    }

    public final b2 h() {
        return ha.d.b(this, super.h());
    }

    public final void r0() {
        if (this.f9248k0 == null) {
            this.f9248k0 = new l(super.v(), (c0) this);
            this.f9249l0 = ea.b.a(super.v());
        }
    }

    public final Context v() {
        if (super.v() == null && !this.f9249l0) {
            return null;
        }
        r0();
        return this.f9248k0;
