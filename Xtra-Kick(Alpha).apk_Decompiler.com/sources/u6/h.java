...
public abstract class h extends l implements b {
    public boolean A0;
    ...
    public dagger.hilt.android.internal.managers.l f15369z0;

    private void N0() {
        if (this.f15369z0 == null) {
            this.f15369z0 = new dagger.hilt.android.internal.managers.l(super.v(), (c0) this);
    ...
    public final void L(Activity activity) {
        boolean z10;
        this.K = true;
        dagger.hilt.android.internal.managers.l lVar = this.f15369z0;
    ...
    public final Object c() {
        if (this.B0 == null) {
            synchronized (this.C0) {
                if (this.B0 == null) {
                    this.B0 = new dagger.hilt.android.internal.managers.h((c0) this);
                }
            }
        }
        return this.B0.c();
