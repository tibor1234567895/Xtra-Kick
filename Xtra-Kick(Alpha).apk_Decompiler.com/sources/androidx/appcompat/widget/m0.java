...
public class m0 extends ImageButton {
    ...
    public final b0 f927h;

    /* renamed from: i  reason: collision with root package name */
    public final n0 f928i;

    /* renamed from: j  reason: collision with root package name */
    public boolean f929j = false;
    ...
    public final boolean hasOverlappingRendering() {
        if (!(!(((ImageView) this.f928i.f964b).getBackground() instanceof RippleDrawable)) || !super.hasOverlappingRendering()) {
            return false;
        }
        return true;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        n0 n0Var = this.f928i;
        if (!(n0Var == null || drawable == null || this.f929j)) {
