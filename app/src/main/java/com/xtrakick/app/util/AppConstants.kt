...
object AppConstants {
    ...
    const val USAGE_PING_SEED = "usage_ping_seed"
    const val USAGE_PING_LAST_DAY = "usage_ping_last_day"
    const val USAGE_STATS_ENABLED = "usage_stats_enabled"
    const val USAGE_SESSIONS_DAY = "usage_sessions_day"
    const val USAGE_SESSIONS_TODAY = "usage_sessions_today"
    ...
    const val PLAYER_KICK_LIVE_ENGINE = "player_kick_live_engine"
    ...
    const val LAST_PLAYBACK_TITLE = "last_playback_title"
    const val LAST_PLAYBACK_CHANNEL_NAME = "last_playback_channel_name"
    const val LAST_PLAYBACK_CHANNEL_LOGO = "last_playback_channel_logo"
    const val LAST_PLAYBACK_STARTED_AT_MS = "last_playback_started_at_ms"
    const val ACTIVE_LIVE_CHANNEL_ID = "active_live_channel_id"
    const val ACTIVE_LIVE_CHANNEL_LOGIN = "active_live_channel_login"
    const val ACTIVE_LIVE_UPDATED_MS = "active_live_updated_ms"
    ...
    const val PIP_SHOW_AUDIO_ONLY = "pip_show_audio_only"
    const val PIP_SHOW_MUTE = "pip_show_mute"
    const val PIP_REDUCED_VOLUME_LEVEL = "pip_reduced_volume_level"
    const val PLAYER_PRE_MUTE_VOLUME = "player_pre_mute_volume"
    ...
    const val CHAT_ALTERNATING_LINE_SHADOW = "chat_alternating_line_shadow"
    const val CHAT_ALTERNATING_LINE_SHADOW_STRENGTH = "chat_alternating_line_shadow_strength"
    const val CHAT_DELAY_MODE = "chat_delay_mode"
    const val CHAT_DELAY_CUSTOM_SECS = "chat_delay_custom_secs"
    const val CHAT_SHOW_DELAY_INDICATOR = "chat_show_delay_indicator"
    ...
    const val KICK_OAUTH_BACKEND_BASE_URL = "kick_oauth_backend_base_url"
    const val KICK_DEBUG_CLIENT_ID_OVERRIDE = "kick_debug_client_id_override"
    const val KICK_DEBUG_OAUTH_BACKEND_OVERRIDE = "kick_debug_oauth_backend_override"
    const val KICK_REDIRECT_URI = "kick_redirect_uri"
    const val KICK_SCOPES = "kick_scopes"
    const val KICK_ACCESS_TOKEN = "kick_access_token"
    const val KICK_REFRESH_TOKEN = "kick_refresh_token"
    const val KICK_ACCESS_TOKEN_EXPIRES_AT = "kick_access_token_expires_at"
    const val KICK_TOKEN_TYPE = "kick_token_type"
    const val KICK_USER_ID = "kick_user_id"
    ...
    const val NOTIFICATION_KEYS_MIGRATED = "notification_keys_migrated_v2"
    ...
    const val DEFAULT_API_PREFS_GAMES = "3:1"
    const val DEFAULT_API_PREFS_STREAMS = "3:1"
    const val DEFAULT_API_PREFS_FOLLOWED_GAMES = "3:1"
    const val DEFAULT_API_PREFS_FOLLOWED_STREAMS = "3:1"
    const val DEFAULT_API_PREFS_FOLLOWED_CHANNELS = "3:1"
    const val DEFAULT_API_PREFS_CHANNEL_VIDEOS = "3:1"
    const val DEFAULT_API_PREFS_CHANNEL_CLIPS = "3:1"
    const val DEFAULT_API_PREFS_GAME_STREAMS = "3:1"
    const val DEFAULT_API_PREFS_GAME_CLIPS = "3:1"
    const val DEFAULT_API_PREFS_SEARCH_VIDEOS = "3:1"
    ...
    const val UPDATE_SKIPPED_RELEASE_TIME = "update_skipped_release_time"
    const val UPDATE_LAST_CHECK_TIMESTAMP = "update_last_check_timestamp"
    ...
    const val LIVE_NOTIFICATIONS_POLLING_BACKUP = "live_notifications_polling_backup"
    ...
    const val REWARD_DAILY_BACKOFF_UNTIL = "reward_daily_backoff_until"
    ...
    const val DEBUG_MOCK_UPDATE_AVAILABLE = "debug_mock_update_available"
    ...
    const val FOLLOWED_LIVE_AUTO_REFRESH_INTERVAL = "followed_live_auto_refresh_interval"
    const val FOLLOWED_LIVE_REFRESH_ON_RETURN = "followed_live_refresh_on_return"
}
