...
import com.xtrakick.app.databinding.FragmentStreamsListItemCompactBinding
...
class StreamsCompactListAdapter(
    private val fragment: Fragment,
    private val selectTag: (String) -> Unit,
    private val showGame: Boolean = true,
) : ListAdapter<Stream, StreamsCompactListAdapter.ViewHolder>(DiffCallback) {
        ...
        fun bind(item: Stream) {
            with(binding) {
                ...
                if (item.viewerCount != null) {
                    ...
                    viewers.text = KickApiHelper.formatCount(item.viewerCount ?: 0, context.prefs().getBoolean(AppConstants.UI_TRUNCATEVIEWCOUNT, true))
                } else {
