        ...
        fun bind(item: Bookmark?) {
            with(binding) {
                if (item != null) {
                    ...
                    if (item.type?.lowercase() == "archive" && userType != null && item.createdAt != null && context.prefs().getBoolean(AppConstants.UI_BOOKMARK_TIME_LEFT, true) && !ignore) {
                    ...
                    options.setOnClickListener { it ->
                        PopupMenu(context, it).apply {
                            ...
                            if (item.type?.lowercase() == "archive" && item.userId != null && context.prefs().getBoolean(AppConstants.UI_BOOKMARK_TIME_LEFT, true)) {
