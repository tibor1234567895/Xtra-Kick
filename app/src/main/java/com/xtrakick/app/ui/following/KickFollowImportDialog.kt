...
import com.xtrakick.app.databinding.DialogKickFollowImportBinding
...
class KickFollowImportDialog : DialogFragment() {
    ...
    private fun isDebugLoggingEnabled(): Boolean {
        return BuildConfig.DEBUG && requireContext().prefs().getBoolean(AppConstants.DEBUG_KICK_FOLLOW_IMPORT_LOGS, false)
    }
