...
import com.xtrakick.app.databinding.FragmentFollowedGamesListItemBinding
        ...
        fun bind(item: Game?) {
            with(binding) {
                if (item != null) {
                    ...
                    if (item.broadcastersCount != null && context.prefs().getBoolean(AppConstants.UI_BROADCASTERSCOUNT, true)) {
