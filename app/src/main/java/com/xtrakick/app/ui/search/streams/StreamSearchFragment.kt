...
import com.xtrakick.app.ui.common.StreamsAdapter
import com.xtrakick.app.ui.common.StreamsCompactAdapter
import com.xtrakick.app.ui.search.RecentSearchAdapter
import com.xtrakick.app.ui.search.SearchPagerFragment
import com.xtrakick.app.ui.search.Searchable
...
class StreamSearchFragment : PagedListFragment(), Searchable {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        pagingAdapter = if (requireContext().prefs().getString(AppConstants.COMPACT_STREAMS, "disabled") != "disabled") {
    ...
    override fun initialize() {
            ...
            viewLifecycleOwner.lifecycleScope.launch {
                repeatOnLifecycle(Lifecycle.State.STARTED) {
                    pagingAdapter.loadStateFlow.collectLatest { loadState ->
                        ...
                        if (viewModel.query.value.isBlank() && requireContext().prefs().getBoolean(AppConstants.UI_STORE_RECENT_SEARCHES, true)) {
        ...
        if (requireContext().prefs().getBoolean(AppConstants.UI_STORE_RECENT_SEARCHES, true)) {
            viewLifecycleOwner.lifecycleScope.launch {
                repeatOnLifecycle(Lifecycle.State.STARTED) {
