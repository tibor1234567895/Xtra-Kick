...
import com.xtrakick.app.databinding.FragmentDownloadsListItemBinding
            ...
            with(binding) {
                if (item != null) {
                    ...
                    item.duration?.let { itemDuration ->
                        ...
                        if (context.prefs().getBoolean(AppConstants.PLAYER_USE_VIDEOPOSITIONS, true) && item.lastWatchPosition != null && itemDuration > 0L) {
